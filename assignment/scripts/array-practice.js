...
let favoriteFoods = ["Rice", "goatmeats", "Pasta", "Anjera"];

console.log("my favorite food is ", favoriteFoods);
let countMyfavoriteFoods = favoriteFoods.length;
// Array.length: A property that tells you how many items are in a given array.
console.log("the length of my array is", countMyfavoriteFoods);
...
console.log("the total items of of this is ", numberOfFoods);
...
console.log("Printing last element using length property: ", lastAnimal);
...
let addFavoriteFood = "desert";
favoriteFoods.push(addFavoriteFood);
console.log("Added an a new favoriate food to my main menu", favoriteFoods);
...
addFavoriteFood = "entree";
favoriteFoods.unshift(addFavoriteFood);
console.log(
  "Added new food favorite at the start to my main menu",
  favoriteFoods
);
...
console.log("Removed last color in the array", colors);
console.log("and assigned that color to a new varaiable", lastColor);
...
console.log("Removed first color in the array", colors);
console.log("and assigned that color to a new varaiable", firstColor);
